...
class service_container_prod_ea32c1db extends \Drupal\Core\DependencyInjection\Container
{
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Drupal\Core\Template\TwigEnvironment($this->get('app.root'), $this->get('cache.default'), $a, array('debug' => true, 'auto_reload' => NULL, 'cache' => false));
